...
$sql = 'SELECT * FROM images'; //NON è PHP è codice SQL ed è il codice con cui si parla al database. Tutte le parole chiave vanno scritte tutte in maiuscolo
//$sql prende l'intera tabella presente sul database.
...
<!-- Parte dinamica della tabella -->
    <tr>
        <td><?= $row['image_id'] ?></td>
        <td><?= safe($row['filename']) ?></td> <!--utilizza la funzione safe creata in utility_fucs.php-->
