...
$sql = 'SELECT filename, caption FROM images'; //NON è PHP è codice SQL ed è il codice con cui si parla al database. Tutte le parole chiave vanno scritte tutte in maiuscolo
//Prima $sql prendeva tutta la tabella sul database, ora prende solo filename e caption.
...
<!-- Parte statica della tabella, i titoli, rimossa image_id poiché non la prendiamo più dal database -->
    <tr>
        <th>filename</th>
        <th>caption</th>
    </tr>
...
<!-- Parte dinamica della tabella, sostituito image_id con filename -->
    <tr>
        <td><?= $row['filename'] ?></td>
