...
//NON è PHP è codice SQL ed è il codice con cui si parla al database. Tutte le parole chiave vanno scritte tutte in maiuscolo.

$sql = 'SELECT * FROM images WHERE caption LIKE BINARY "%maiko%"'; //Il doppio percentuale(% %) permette di prendere sia minuscole che maiuscole.
                                                                    //BINARY prende solo in minuscolo, come è scritto.
//Ora $sql prende tutta la tabella dal database ma prendendo soltanto dove è presente la parola maiko nella caption.
//Può risultare più facile leggere e scrivere se mandato a capo.
